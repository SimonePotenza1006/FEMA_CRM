...
class NuovaDestinazionePage extends StatefulWidget {
  ...
  const NuovaDestinazionePage({Key? key1, required this.cliente}) : super(key : key1);
...
class _NuovaDestinazionePageState extends State<NuovaDestinazionePage>{
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    createNewDestinazione(denominazione, indirizzo, cap, citta, provincia, codice_fiscale, partita_iva, telefono, cellulare, cliente);
                  }
                },
                child: Text('Salva'),
              )
  ...
  Future<void> createNewDestinazione(String denominazione, String indirizzo, String cap, String citta, String provincia, String codice_fiscale, String partita_iva, String telefono, String cellulare, ClienteModel cliente) async{
    print('${widget.cliente}');
    final url = Uri.parse('http://192.168.1.52:8080/api/destinazione');
