...
class _CalendarioUtentePageState extends State<CalendarioUtentePage> {
  ...
  Future<void> getAllCommissioniByUtente() async {
    try {
      var apiUrl = Uri.parse('$ipaddressProva2/api/commissione/utente/${widget.utente!.id}');
  ...
  //     var apiUrl = Uri.parse('$ipaddressProva2/api/intervento/utente/${int.parse(widget.utente!.id.toString())}');
  //     var response = await http.get(apiUrl);
  //     if (response.statusCode == 200) {
  ...
  Future<void> getAllInterventiBySettore() async {
    try {
      ...
      var apiUrl = Uri.parse('$ipaddressProva2/api/intervento/categoriaIntervento/'+widget.utente!.tipologia_intervento!.id.toString());
      var response = await http.get(apiUrl);
      if (response.statusCode == 200) {
        print('getAllInterventiByUtente: successo, status code: ${response.statusCode}');
        var jsonData = jsonDecode(response.body);
