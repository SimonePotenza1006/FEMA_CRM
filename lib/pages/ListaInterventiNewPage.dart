...
class ListaInterventiNewPage extends StatefulWidget {
  const ListaInterventiNewPage ({Key? key}) : super(key : key);

  @override
  _ListaInterventiNewPageState createState() => _ListaInterventiNewPageState();
}

class _ListaInterventiNewPageState extends State<ListaInterventiNewPage>{
                    ...
                    children: [
                      Container(
                        ...
                        child: DataTable(
                          ...
                          rows: allGruppiNonConclusi.map((gruppo) {
                            return DataRow(
                              cells: [
                                DataCell(
                                  Text(gruppo.cliente?.denominazione ?? 'N/A'),
                                ),
                                DataCell(
                                  Text(gruppo.descrizione ?? 'N/A'),
                                ),
                                DataCell(
                                  Text(gruppo.importo?.toStringAsFixed(2) ?? 'N/A'),
                                ),
                                DataCell(
                                  Container(
