    ...
    switch (index) {
      ...
      case 2:
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => ReportCommissioniPerAgentePage()),
        );
        break;
    }
  }
...
class MenuPainter extends CustomPainter {
  ...
  final List<MenuItem> _menuItems = [
    MenuItem(icon: Icons.playlist_add, label: 'ASSEGNA COMMISSIONE'),
    MenuItem(icon: Icons.bar_chart_outlined, label: 'REPORT COMMISSIONI'),
    MenuItem(icon: Icons.folder_shared_outlined, label: 'REPORT COMMISSIONI UTENTE'),
  ];
