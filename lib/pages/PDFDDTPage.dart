...
class PDFDDTPage extends StatefulWidget {
  ...
  PDFDDTPage({required this.ddt, required this.azienda});

  @override
  _PDFDDTPageState createState() => _PDFDDTPageState();
}

class _PDFDDTPageState extends State<PDFDDTPage> {
              ...
              pw.Row(
                children: [
                  ...
                  pw.Padding(
                    padding: pw.EdgeInsets.only(right: 3),
                    child: pw.Text(
                      widget.ddt.intervento?.destinazione?.denominazione ?? '',
                      style: pw.TextStyle(fontSize: 9),
                    ),
                  ),
                ],
              ...
              pw.Row(
                children: [
                  ...
                  pw.Padding(
                    padding: pw.EdgeInsets.only(right: 3),
                    child: pw.Text(
                      widget.ddt.intervento?.destinazione?.indirizzo ?? '',
                      style: pw.TextStyle(fontSize: 9),
                    ),
                  ),
                ],
              ...
              pw.Row(
                children: [
                  ...
                  pw.Padding(
                    padding: pw.EdgeInsets.only(right: 3),
                    child: pw.Text(
                      widget.ddt.intervento?.destinazione?.cap ?? '',
                      style: pw.TextStyle(fontSize: 9),
                    ),
                  ),
                  pw.Padding(
                  ...
                  pw.Padding(
                    padding: pw.EdgeInsets.only(right: 3),
                    child: pw.Text(
                      widget.ddt.intervento?.destinazione?.citta ?? '',
                      style: pw.TextStyle(fontSize: 9),
                    ),
                  ),
                  pw.Padding(
                    padding: pw.EdgeInsets.only(left: 45, right: 3),
                    child: pw.Text(
                      '(${widget.ddt.intervento?.destinazione?.provincia})',
                      style: pw.TextStyle(fontSize: 9),
                    ),
                  ),
                ],
              ...
              pw.Row(
                children: [
                  ...
                  pw.Padding(
                    padding: pw.EdgeInsets.only(right: 3),
                    child: pw.Text(
                      widget.ddt.intervento?.destinazione?.telefono ?? '',
                      style: pw.TextStyle(fontSize: 9),
                    ),
                  ),
                  pw.Padding(
                  ...
                  pw.Padding(
                    padding: pw.EdgeInsets.only(right: 3),
                    child: pw.Text(
                      widget.ddt.intervento?.destinazione?.cellulare ?? '',
                      style: pw.TextStyle(fontSize: 9),
                    ),
                  ),
                ],
  ...
  pw.Widget _buildProdottiTable(List<RelazioneDdtProdottoModel> relazione) {
