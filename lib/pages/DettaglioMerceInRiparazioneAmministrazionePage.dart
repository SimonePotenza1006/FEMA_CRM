                            ...
                            SizedBox(
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 10.0),
                                  buildInfoRow(title: "data accettazione preventivo", value:(widget.merce.data_presa_in_carico != null ? DateFormat('dd/MM/yyyy').format(widget.merce.data_accettazione_preventivo!) : 'N/A' )),
                                  SizedBox(height: 10),
                                ],
                              ),
                            ),
