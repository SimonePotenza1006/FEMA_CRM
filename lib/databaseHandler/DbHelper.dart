...
class DbHelper{
  ...
  Future<void> uploadCertificazioneImpianto(
    ...
    while (retryCount < maxRetry) {
      try {
        ...
        var postUri = Uri.parse('$ipaddress2/pdfu/certificazioni/clienti'); // Endpoint corretto
  ...
  Future<List<String>> getAllDevice() async {
    ...
    try{
      ...
      await http
          .get(Uri.parse('$ipaddress2/api/device'));
  ...
  Future<http.Response> saveLicenzaNo(String user) async {
    ...
    try {
      response = await http.post(
          ...
          Uri.parse('$ipaddress2/api/licenza',),
          headers: {
  ...
  Future<http.Response> saveDevice(DeviceModel user) async {
    ...
    try {
      response = await http.post(
          ...
          Uri.parse('$ipaddress2/api/device',),
          headers: {
            "Accept": "application/json",
            "Content-Type": "application/json"
          },
  ...
  Future<List<String>> getAllLicenze() async {
    try{
      http.Response response =
      await http
          .get(Uri.parse('$ipaddress2/api/licenza'));
      var responseData = json.decode(response.body.toString());
      if (response.statusCode == 200) {
        print("gf45tr54");
        print(responseData.toString());
  ...
  Future<Uint8List> getPdfNoleggio(String filename)  async {
    final response =
    await http.get(Uri.parse('$ipaddress2/api/pdf/preventiviServizi/$filename'));
  ...
  Future<List<FaseRiparazioneModel>> getFasiByMerce(InterventoModel intervento) async{
    ...
    try{
      final response = await http.get(Uri.parse('$ipaddress2/api/fasi/merce/$merceId'));
      if(response.statusCode == 200){
        final jsonData = jsonDecode(response.body);
  ...
  Future<List<DestinazioneModel>> getDestinazioneByCliente(ClienteModel cliente) async{
    ...
    try{
      final response = await http.get(Uri.parse('$ipaddress2/api/destinazione/cliente/${clienteId}'));
      if(response.statusCode == 200){
         final jsonData = jsonDecode(response.body);
  ...
  Future<List<String>> getFilesnamePreventivi() async {
    try {
      final response = await http.get(Uri.parse('$ipaddress2/api/pdf/preventiviServizi'));
  ...
  Future<void> uploadPdfPreventivoServizi(String uploadimage, io.File? uploadimageF) async {
    ...
    if (fileD.existsSync()) {
      ...
      var postUri = Uri.parse('$ipaddress2/api/pdf/preventivoServizi');
  ...
  Future<List<AziendaModel>> getAllAziende() async{
    try{
      http.Response response = await http.get(Uri.parse('$ipaddress2/api/azienda'));
  ...
  Future<List<TipologiaInterventoModel>> getAllTipologieIntervento() async{
    try{
      http.Response response = await http.get(Uri.parse('$ipaddress2/api/tipologiaIntervento'));
      var responseData = json.decode(response.body.toString());
      if (response.statusCode == 200) {
  ...
  Future<UtenteModel> getUtentebyId(String userId) async {
    final response =
    await http.get(Uri.parse('$ipaddress2/api/utente/$userId'));
